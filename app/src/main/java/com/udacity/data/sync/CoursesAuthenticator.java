...
/**
 * Manages "Authentication" to Udacity's backend service.  The SyncAdapter framework
...
public class CoursesAuthenticator extends AbstractAccountAuthenticator {

    public CoursesAuthenticator(Context context) {
        super(context);
    }
